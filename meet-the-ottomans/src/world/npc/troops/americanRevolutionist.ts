...
export class AmericanRevolutionist extends npc {
  ...
  constructor(id: number, modelEntity: Entity = new Entity("american revolutionist")) {
  ...
  private fireProjectileAt(
    ...
    const projectile = new Entity("revolutionist bullet");
    projectile.setPosition(origin);
    projectile.lookAt(origin.clone().add(dir));

    const tracer = new Entity("revolutionist bullet tracer");
