...
export class FrenchSoldier extends npc {
    ...
    constructor(id: number, modelEntity: Entity = new Entity("french soldier")) {
    ...
    private fireProjectileAt(
        ...
        const projectile = new Entity("french bullet");
        projectile.setPosition(origin);
        projectile.lookAt(origin.clone().add(dir));

        const tracer = new Entity("french bullet tracer");
