 ...
 * The coordinates point to a real place; the truth does not.
 */
...
export async function battleOfNorthwoodHighScene(
  ...
  try {
    ...
    console.error("[NorthwoodHigh] Failed to spawn boss:", err);
  }
  ...
  bindNpcCombatLoop(app, npcs, () => player.getCameraEntity(), {
    ...
    battleStatus: {
      ...
      initialTotal: NORTHWOOD_HIGH_SPAWN_POINT.length,
