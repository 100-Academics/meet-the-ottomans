...
//comment this out because its breaking the game for some reason
...
// Give Ammo.js time to register collision bodies before raycasting.
await waitForAmmoReady(app, "ground");;
	...
	// Create a foggy, low-visibility look (historical Pavia was foggy)
