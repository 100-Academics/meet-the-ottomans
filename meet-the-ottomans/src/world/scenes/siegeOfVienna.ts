...
import {
  ...
  VIENNA_BOSS_SPAWN_POINT,
  VIENNA_NPC_SPAWN_POINTS,
...
export async function siegeOfViennaScene(
  ...
  addStarField(app, cameraEntity, "vienna-star-dome");
    ...
    spawnBoss: () => {
      bossState.runBossSpawn(() =>
        spawnSceneBoss({
          ...
          rigidbodySystem,
          npcs,
          spawnPoint: VIENNA_BOSS_SPAWN_POINT,
          bossOptions: DEFAULT_WINGED_HUSSAR_BOSS_SPAWN_OPTIONS,
          groundYFallback: respawnGroundY,
          extraOptions: { groundProbeHeight: 500, groundProbeDepth: 500 },
        }),
