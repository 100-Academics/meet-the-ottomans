...
import {
  ...
  AGINCOURT_BOSS_SPAWN_POINT,
  AGINCOURT_NPC_SPAWN_POINTS,
...
export async function battleOfAgincourtScene(
  ...
  addStarField(app, cameraEntity, "agincourt-star-dome");
    ...
    spawnBoss: () => {
      bossState.runBossSpawn(() =>
        spawnSceneBoss({
          ...
          rigidbodySystem,
          npcs,
          spawnPoint: AGINCOURT_BOSS_SPAWN_POINT,
          bossOptions: DEFAULT_WILLIAM_BOSS_SPAWN_OPTIONS,
          groundYFallback: respawnGroundY,
        }),
